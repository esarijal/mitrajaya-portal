...
function RegionalBreadcrumb({
  ...
  const createUrl = (region: PathTitle["region"]) => {
    switch (region) {
      case "province":
        return `/daerah/${prov_id}/${prov_name}`;
      case "city":
        return `/daerah/${prov_id}/${prov_name}/${city_id}/${city_name}`;
      case "district":
        return `/daerah/${prov_id}/${prov_name}/${city_id}/${city_name}/${district_id}/${district_name}`;
      case "subdistrict":
        return `/daerah/${prov_id}/${prov_name}/${city_id}/${city_name}/${district_id}/${district_name}/${subdistrict_id}/${subdistrict_name}`;
    }
  };
